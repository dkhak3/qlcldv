export const DEFAULT_REPORT_BOXES = [
  ...
  { id: "txdl", key: "txdl", slug: "bao-cao-txdl", title: "Báo cáo tuần TXDL", description: "Lọc phản ánh, đối chiếu dữ liệu và xuất báo cáo TXDL ngay trong hệ thống.", route: "/bao-cao-txdl", externalUrl: "https://txdl-project.vercel.app/", videoUrl: "", appearance: "emerald", icon: "file-spreadsheet", hidden: false, sortOrder: 3, system: true },
